...
const MapAndCentersGrid = ({ branch }) => (
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 mb-6 sm:mb-8 lg:mb-10">
    ...
    <div className="order-2 lg:order-1">
      <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-blue-800 mb-3 sm:mb-4 flex items-center gap-2">
    ...
    <div className="order-1 lg:order-2">
      <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-blue-800 mb-3 sm:mb-4 flex items-center gap-2">
        ...
        <span className="truncate">Collection Centers</span>
      </h3>
      <div className="space-y-3 sm:space-y-4 max-h-[400px] sm:max-h-[500px] lg:max-h-[450px] overflow-y-auto pr-1">
